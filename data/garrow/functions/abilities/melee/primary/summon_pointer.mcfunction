...
execute align xyz run summon armor_stand ~0.5 ~-1 ~0.5 { CustomName: '{ "text": "GOLDARK_POINTER" }', Tags: [ goldark.pointer_dummy ], Invisible: 1b, Invulnerable: 1b, Small: 1b }
...
scoreboard players set @e[type=armor_stand, tag=goldark.pointer_dummy, distance=..1] goldark.ability_timer 100