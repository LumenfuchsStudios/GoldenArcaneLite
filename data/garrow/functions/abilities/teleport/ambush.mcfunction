...
# Variant of "ambush", teleports Golden Arrow just behind the player; Almost always triggers melee mode.
...
execute if entity @s[tag=garrow.run_teleport] run scoreboard players set @s goldark.ability_clock -600