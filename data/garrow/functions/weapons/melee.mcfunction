...
# With a 1/10 chance, Golden Arrow will swap its swords, using Demise against the player instead.
...
execute if entity @s[tag=garrow.invert_melee] run item replace entity @s weapon.offhand with golden_sword{ display: { Name: '{ "text": "Banishment", "italic": false, "color": "yellow" }', Lore: [ '{ "text": "Divine hellfire..." }' ] }, Enchantments: [ { id: sharpness, lvl: 3 }, { id: bane_of_arthropods, lvl: 2 }, { id: mending, lvl: 1 } ] }
...
execute if entity @s[tag=garrow.invert_melee] run item replace entity @s weapon.mainhand with golden_sword{ display: { Name: '{ "text": "Demise", "italic": false, "color": "gold" }', Lore: [ '{ "text": "Unpleasantly painful." }' ] }, Enchantments: [ { id: smite, lvl: 4 }, { id: fire_aspect, lvl: 2 }, { id: vanishing_curse, lvl: 1 } ] }
