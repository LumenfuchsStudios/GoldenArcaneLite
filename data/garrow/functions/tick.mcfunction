...
execute unless entity @s[tag=garrow.dash_mode] if entity @a[tag=garrow.in_battle, distance=..24] run function garrow:weapons/swap_mode

# Run Golden Arrow's ability module while a player is nearby.
execute if entity @a[tag=garrow.in_battle, distance=..24] run function garrow:abilities/main
